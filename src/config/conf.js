...
export const config = {
	...
	//
	// 	chromeOptions: {
	// 		binary: path.resolve( __dirname, "../../node_modules/google-chrome-44.0.2403.157/chrome.exe" )
	// 	},
	...
	onPrepare() {
		...
		reporterPlugin.getBrowser = () => { return browser; };
		...
		return getIPaddress().then( ip => {
			...
			return browser.driver.manage().window().setPosition( x, y ).then( () => {
