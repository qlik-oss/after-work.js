...
export const runner = {
	 ...
	 * @return {Object}         The parsed info object containing `commandArgs`, `addMochaArgs`, `hasArgumentsSeparator`
	 */
	parseArgs( args ) {
		...
		return {
			...
			addMochaArgs: addMochaArgs,
			hasArgumentsSeparator: hasArgumentsSeparator
		};
	},
