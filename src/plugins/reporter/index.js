...
export default function uiReport( runner, options ) {
	...
	if ( options.reporterOptions && options.reporterOptions.xunit ){
		let xunitName = info.browserName + "-report-" + info.startTime + ".xml";
	...
	runner.on( "end", function() {
		...
		let reportName = info.browserName + "-report-" + info.startTime + ".json";
		let fileName = path.resolve( artifactsPath, reportName );
