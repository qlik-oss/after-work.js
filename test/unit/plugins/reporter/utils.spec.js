...
describe( "Reporter Utils", () => {
	...
	describe( "cleanTest", () => {
		let test = {
			...
			"fullTitle": function(){ return "Component: variant should match baseline"; },
			"fn": {
				"toString": function(){}
			},
	...
	describe( "saveScreenshot", () => {
		...
		it( "should save screenshot to disk", () => {
			return utils.saveScreenshot( global.browser, title ).then( () => {
