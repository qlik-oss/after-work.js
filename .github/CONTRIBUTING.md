...
You are more than welcome to contribute to after-work.js! Follow these guidelines and you will be ready to start:
...
```sh
git clone git@github.com:YOUR-USERNAME/after-work.js.git
```
...
”
```sh
git commit -m "Bugfix: Fix protractor sometimes not starting."
```
...
- Use the present form, e.g. _Update mocha dependency_
