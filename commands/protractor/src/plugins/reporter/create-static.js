...
let template = fs.readFileSync(
  path.resolve(__dirname, "templates/main.handlebars"),
  {
    encoding: "utf8",
  }
);
...
Handlebars.registerHelper("addLocalCSS", (cssPath) =>
  fs.readFileSync(path.resolve(__dirname, cssPath), {
    encoding: "utf8",
  })
);
